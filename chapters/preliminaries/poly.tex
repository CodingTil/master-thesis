...
\begin{theorem}[Minkowski-Weyl \cite{chappell2019minkowski}]\label{th:minkowski-weyl}
...
\begin{theorem}[Nemhauser-Wolsey \cite{wolsey2014integer}]\label{th:nemhauser-wolsey}
...
\begin{theorem}[Nemhauser-Wolsey \cite{wolsey2014integer}]\label{th:nemhauser-wolsey-integer}
