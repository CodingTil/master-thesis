...
\end{tikzpicture}
\caption{Illustration of the Minkowski-Weyl theorem. The left figure shows a fully encapsulated polyhedron which can be represented only by its extreme points. Unbounded polyhedra, such as the one on the right, require extreme rays, drawn in red, to be described completely.}
...
\begin{theorem}[Nemhauser-Wolsey]\label{th:nemhauser-wolsey-integer}
